                    			...
                    			<td>
                    				...
                    				<label>
                    					...
                    					<?php 
                    						...
                    						{ ?>
                    							<span ><?php echo $selQuestRow['exans_answer']; ?></span>
                    						<?PHP }
                    						else
                    						{ ?>
                    							<span "><?php echo $selQuestRow['exans_answer']; ?></span>
                ...
                <div class="widget-content-wrapper text-white">
                    ...
                    <div class="widget-content-right">
                        <div class="widget-numbers text-white">
                            <?php 
                                $selScore = $conn->query("SELECT * FROM exam_question_tbl eqt INNER JOIN exam_answers ea ON eqt.eqt_id = ea.quest_id AND eqt.exam_answer = ea.exans_answer  WHERE ea.axmne_id='$exmneId' AND ea.exam_id='$examId'  ");
                            ?>
                            <span>
